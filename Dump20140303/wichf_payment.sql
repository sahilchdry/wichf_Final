...
CREATE TABLE `payment` (
  ...
  `type_of_card` varchar(45) DEFAULT NULL,
  `card_holder_name` varchar(45) NOT NULL,
  `expiry_date` varchar(45) DEFAULT NULL,
  `appointment_id` int(11) NOT NULL,
  PRIMARY KEY (`payment_id`),
  KEY `fk_appoint_id_idx` (`appointment_id`),
  CONSTRAINT `fk_appoint_id` FOREIGN KEY (`appointment_id`) REFERENCES `appointment` (`appointment_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
