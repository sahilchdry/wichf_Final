...
CREATE TABLE `nurse` (
  ...
  CONSTRAINT `fk_Nurse_User1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `nurse` VALUES (1,'swapnil','active','swapnil');
...
-- Dump completed on 2014-02-28 23:55:10
